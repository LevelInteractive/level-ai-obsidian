...
description: >
  ...
  and moments of excellence from across the vault — Slack activity, meetings, Codex sessions, and
...
The wiki captures synthesis, not texture. Raw sources surface wins that haven't been written up yet — individual moments in Slack, specific meeting contributions, Codex sessions that built something new. Go here to deepen and expand.
...
|---|---|---|
| Praise / thanks | `"thank you" OR "shout out" OR "great job" OR "nice work"` | `a colleague or client praised Nick's work or said thank you` |
| Resolved problems | `resolved OR fixed OR unblocked OR launched OR shipped` | `Nick diagnosed or resolved a problem, or shipped something new` |
| Ownership / initiative | `owned OR automated OR proactively` | `Nick took initiative, drove a decision, or automated something repeatable` |
...
For every win, identify the most relevant Core Value or Key Behavior it demonstrates. This turns a win from "something good happened" into "evidence of how Nick works."
...
What does this window reveal about how Nick works best, or what's worth doubling down on?]
