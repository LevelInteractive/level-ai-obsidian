...
- **Raw sources**: `Data\Meetings`, `Data\Work`, `Data\Daily`, `Data\Inbox`, `Data\Resources`, `Data\Personal`, `Data\Claude`
...
Follow `## References` wikilinks into `Data/` to read the supporting raw files. Use the information to either confirm the insight or revise it. Update your working notes but **do not modify any wiki pages** during this skill — insights are read-only.
